...
class ViewStream extends \DOMImplementation
{
  ...
  public function __construct()
  {
    ...
    $this->Dom->registerNodeClass('DOMProcessingInstruction', 'Leaf\CodeNodes\PhpNode');
    ...
    $this->TagsManager->registerModifiers('default', new TagModifiers\BtnModifier());
    $this->TagsManager->registerModifiers('primary', new TagModifiers\BtnModifier());
    $this->TagsManager->registerModifiers('success', new TagModifiers\BtnModifier());
    $this->TagsManager->registerModifiers('info', new TagModifiers\BtnModifier());
    $this->TagsManager->registerModifiers('warning', new TagModifiers\BtnModifier());
    $this->TagsManager->registerModifiers('danger', new TagModifiers\BtnModifier());
  }
